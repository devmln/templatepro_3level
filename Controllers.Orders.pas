...
function TOrdersController.GetOrders:string;
begin
 var lDS := TMVCActiveRecord.All<Torder>;
try
    ViewData['orders'] := lDS;
    Result := Page('orders');
...
function TOrdersController.GetOrders2:string;
begin
 var lDS := TMVCActiveRecord.All<Torder>;
try
    ViewData['orders'] := lDS;
