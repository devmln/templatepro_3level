...
type
  ...
  private
    ...
    fTotal: Currency;
    [MVCOwned]
    farticles: TObjectList<TArticles>;
  ...
  public
    ...
    property Articles: TObjectList<TArticles> read farticles;
  end;
...
begin
  inherited Create;
  farticles := TObjectList<TArticles>.Create(true);
end;
...
procedure TOrderDetail.OnAfterLoad;
var
  lList: TObjectList<TArticles>;
begin
  inherited;
  lList := TMVCActiveRecord.SelectRQL<TArticles>(Format('eq(id,%d)',[IDArticle]), 1000);
  try
    farticles.Clear;
    farticles.AddRange(lList);
    lList.OwnsObjects := False;
  finally
    lList.Free;
  end;
